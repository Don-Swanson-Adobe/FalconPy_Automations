...
#Born out of need to provide the support taem a PCAP WHILE restarting the sensor, This script is designed to setup an RTR Session, put a script on the host (That also happens to stop and start the sensor), run that script, then finally retrieve the output.
